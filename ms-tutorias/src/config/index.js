...
const config = {
    ...
    // notificacionesServiceUrl: eliminado el 20/07 junto con notificaciones.client.js. Su unico
    // consumidor era ese cliente HTTP, que no lo importaba nadie: la Saga notifica por RabbitMQ
    // (patron outbox, ver tutoria.service.js paso 5). La variable MS_NOTIFICACIONES_URL queda sin
    // lector, por eso tambien sale de .env.example y de los manifiestos.
